          ...
          children: [
            SlideTransition(
              ...
              child: SvgPicture.asset(
                ...
                width: double.parse(widget.bottomNavItem.size
                    .toString()), // Add width parameter to increase size
                height: double.parse(widget.bottomNavItem.size
                    .toString()), // Add height parameter to increase size
              ),
            ),
            SizedBox(
