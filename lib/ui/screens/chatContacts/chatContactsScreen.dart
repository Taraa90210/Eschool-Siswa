...
import 'package:eschool/data/models/chat/chatContact.dart';
import 'package:eschool/data/models/chat/chatUser.dart';
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          Align(
            alignment: Alignment.topCenter,
            child: CustomAppbarNoRadius(title: chatsKey),
          ),
          // Align(
          //   alignment: Alignment.topCenter,
