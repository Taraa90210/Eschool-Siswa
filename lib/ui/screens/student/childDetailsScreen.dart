...
import 'package:eschool/ui/widgets/system/borderedProfilePictureContainer.dart';
...
import 'package:eschool/ui/widgets/system/latestNoticesContainer.dart';
import 'package:eschool/ui/widgets/system/schoolGalleryContainer.dart';
...
import 'package:eschool/ui/widgets/system/shimmerLoaders/subjectsShimmerLoadingContainer.dart';
import 'package:eschool/ui/widgets/system/shimmerLoaders/shimmerLoadingContainer.dart';
import 'package:eschool/ui/widgets/system/slidersContainer.dart';
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          // Update Format nama -- Galang
                          "${widget.student.classSection?.name}",
  ...
  Widget _buildSubjectsAndInformationsContainer() {
    return BlocBuilder<StudentSubjectsAndSlidersCubit,
      ...
      builder: (context, state) {
        ...
        // Tetap tampilkan skeleton saat loading, tapi tanpa wrapper tambahan
