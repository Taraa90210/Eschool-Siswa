...
import 'package:eschool/ui/screens/payment/childFeeDetails/widgets/advanceInstallmentAmountBottomsheet.dart';
import 'package:eschool/ui/screens/payment/childFeeDetails/widgets/downloadReceiptDialog.dart';
import 'package:eschool/ui/screens/payment/childFeeDetails/widgets/feeInformationContainer.dart';
import 'package:eschool/ui/screens/payment/childFeeDetails/widgets/installments.dart';
import 'package:eschool/ui/screens/payment/childFeeDetails/widgets/pendingTransactionWarningDialog.dart';
import 'package:eschool/ui/screens/payment/childFeeDetails/widgets/selectPaymentMethodBottomsheet.dart';
  ...
  Widget _buildAdvanceAmountContainer() {
    return Row(
      children: [
        ...
        const Spacer(),
        Text(
          "${getCurrencySymbol()}${NumberFormat("#,##0", 'id_ID').format(_advanceAmount)}",
                ...
                children: [
                  Row(
                    children: [
                      ...
                      const Spacer(),
                      Text(
                        "${getCurrencySymbol()}${NumberFormat("#,##0", "id_ID").format(outstandingInstallmentsAmount)}",
      ...
      children: [
        Row(
          children: [
            ...
            const Spacer(),
            Text(
              "${getCurrencySymbol()}${NumberFormat("#,##0", 'id_ID').format(feeAmount)}",
        ...
        widget.childFeeDetails.isFeeOverDue()
            ? Row(
                children: [
                  ...
                  const Spacer(),
                  Text(
                    "${getCurrencySymbol()}${NumberFormat("#,##0", 'id_ID').format(dueAmount)}",
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        "${getCurrencySymbol()}${NumberFormat("#,##0.00").format(optionalFee.amount ?? 0)}",
