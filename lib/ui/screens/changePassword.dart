...
class _ChangePasswordScreenState extends State<ChangePasswordScreen> with TickerProviderStateMixin {
    ...
    void initState() {
        ...
        _pulseAnimController = AnimationController(vsync: this, duration: const Duration(milliseconds: 1500));
    ...
    void _handleSubmit(BuildContext context, ChangePasswordState state) {
        ...
        if (!_isPasswordValid) {
            Utils.showCustomSnackBar(
                context: context,
                errorMessage: 'Kata sandi belum memenuhi semua standar keamanan yang diperlukan.',
                backgroundColor: Theme.of(context).colorScheme.error,
            );
            return;
        }
                                                        ...
                                                        FadeInUp(
                                                            ...
                                                            child: BlocConsumer<ChangePasswordCubit, ChangePasswordState>(
                                                                ...
                                                                builder: (context, state) {
                                                                    ...
                                                                    final allFieldsFilled = currentPassword.isNotEmpty && 
                                                                                          newPassword.isNotEmpty && 
                                                                                          confirmPassword.isNotEmpty;
                                                                    ...
                                                                    return GestureDetector(
                                                                        onTap: isButtonEnabled ? () => _handleSubmit(context, state) : null,
