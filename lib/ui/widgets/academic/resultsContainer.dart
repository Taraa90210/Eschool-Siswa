...
import 'package:eschool/ui/widgets/exam/listItemForExamAndResult.dart';
...
class _ResultsContainerState extends State<ResultsContainer> {
            ...
            children: [
              ...
              Align(
                ...
                child: Container(
                  ...
                  child: Text(
                    Utils.getTranslatedLabel(gradedKey),
                    style: TextStyle(
                      ...
                      Expanded(
                        child: GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: currentState.resultFilterTabTitle ==
                                      offlineKey
                            ...
                            child: Text(
                              ...
                              style: TextStyle(
                                ...
                                fontWeight: currentState.resultFilterTabTitle ==
                                        offlineKey
                                    ? FontWeight.bold
                                    : FontWeight.normal,
                              ),
                      ...
                      Expanded(
                        child: GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color:
                                  currentState.resultFilterTabTitle == onlineKey
                                      ? Theme.of(context).colorScheme.primary
                                      : Colors.transparent,
                              borderRadius: BorderRadius.circular(8.0),
                            ),
    ...
    return Column(
      children: [
        ListItemForExamAndResult(
          ...
          examDescription: result.description,
  ...
  Widget _buildOnlineResultDetailsContainer({
    ...
    return ListItemForOnlineExamAndOnlineResult(
      isExamStarted: false,
      statusUjian: result.status_ujian,
      examStartingDate: result.examDate,
      examEndingDate: result.examDate,
      examName: result.examName,
      subjectName: result.subject.name.toString(),
